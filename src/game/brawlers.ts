...
export const BRAWLERS: BrawlerDef[] = [
  {
    ...
    reload: 1.5,
    ammoMax: 3,
    attack: { kind: 'spread', pellets: 5, damage: 340, range: 4.4 * TILE, speed: 640, spread: 0.3, knock: 40 },
    super: { kind: 'bigshot', pellets: 11, damage: 380, range: 5.4 * TILE, speed: 700, spread: 0.55, knock: 160 },
  ...
  },
  {
    ...
    reload: 2.1,
    ammoMax: 3,
    attack: { kind: 'rocket', damage: 1250, range: 8 * TILE, speed: 460, splash: 54 },
    super: { kind: 'barrage', shots: 3, damage: 1100, range: 8.2 * TILE, speed: 520, splash: 62, gap: 0.16 },
  ...
  },
  {
    ...
    reload: 1.6,
    ammoMax: 3,
    attack: { kind: 'burst', shots: 4, damage: 280, range: 8.6 * TILE, speed: 720, gap: 0.07 },
    super: { kind: 'pierce', shots: 8, damage: 360, range: 10.5 * TILE, speed: 940, pierce: 4, gap: 0.06 },
  ...
  },
  {
    ...
    reload: 1.6,
    ammoMax: 3,
    attack: { kind: 'wave', damage: 640, range: 5.6 * TILE, speed: 400, width: 96, pierce: 2 },
